...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train IF_MVTM Model")

    # Add all necessary parameters for configuration
    parser.add_argument('--lr', type=float, default=4e-4, help="Learning rate")
    parser.add_argument('--weight_decay', type=float, default=0.001, help="Weight decay")
    parser.add_argument('--num_channels', type=int, default=17, help="Number of channels")
    parser.add_argument('--num_layers', type=int, default=12, help="Number of layers in transformer")
    parser.add_argument('--num_heads', type=int, default=12, help="Number of attention heads in transformer")
    parser.add_argument('--latent_dim', type=int, default=768, help="Latent dimension size")
    parser.add_argument('--num_codes', type=int, default=1024, help="Number of VQ-VAE codes")
    parser.add_argument('--vqgan_config_path', type=str, required=True, help="Path to VQ-VAE config")
    parser.add_argument('--vqgan_ckpt_path', type=str, required=True, help="Path to VQ-VAE checkpoint")
    parser.add_argument('--vq_dim', type=int, default=4, help="VQ dimension size")
    parser.add_argument('--vq_f_dim', type=int, default=256, help="VQ feature dimension size")
