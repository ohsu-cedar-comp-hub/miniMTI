...
#SBATCH --output=error_logs_reg/train_output_vae%j.out        ### File in which to store job output
#SBATCH --error=error_logs_reg/train_error_vae%j.err          ### File in which to store job error messages
#SBATCH --cpus-per-task=24
#SBATCH --mem=500G
#SBATCH --gres=gpu:a40:8
#SBATCH --time=336:00:00
#SBATCH --job-name train_reg
...
python training_regressor_sped.py