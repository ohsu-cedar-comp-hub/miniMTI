...
#SBATCH --output=error_logs_mints/mints_out%j.out        ### File in which to store job output
#SBATCH --error=error_logs_mints/mints_err%j.err          ### File in which to store job error messages
#SBATCH --cpus-per-task=12
#SBATCH --mem=500G
#SBATCH --gres=gpu:a40:8
#SBATCH --time=336:00:00
#SBATCH --job-name CRC07_mints
